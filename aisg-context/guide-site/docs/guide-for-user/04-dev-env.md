...
`docker/aiap-team-7-project-jokebot-poly-vscode.Dockerfile` to build a
...
=== "Linux/macOS"
    ...
    $ docker build \
        -t asia.gcr.io/$GCP_PROJECT_ID/team_7/vscode-server:0.1.0 \
        -f docker/aiap-team-7-project-jokebot-poly-vscode.Dockerfile \
        --platform linux/amd64 .
    $ docker push asia.gcr.io/$GCP_PROJECT_ID/team_7/vscode-server:0.1.0
    ```
...
=== "Linux/macOS"
    ...
    $ polyaxon run -f aisg-context/polyaxon/polyaxonfiles/vscode-service.yml \
        -P DOCKER_IMAGE="asia.gcr.io/$GCP_PROJECT_ID/team_7/vscode-server:0.1.0" \
...
`http://localhost:8117/ui/default/aiap-team-7-project-jokebot-<YOUR_NAME>/services`.
...
=== "Polyaxon VSCode Terminal"
    ...
    $ cd aiap-team-7-project-jokebot
    ```
...
=== "Linux/macOS"
    ...
    $ export GCP_PROJECT_ID=aiap-10-ds
    $ docker build \
        -t asia.gcr.io/$GCP_PROJECT_ID/team_7/jupyter-server:0.1.0 \
        -f docker/aiap-team-7-project-jokebot-poly-jupyter.Dockerfile \
        --platform linux/amd64 .
    $ docker push asia.gcr.io/$GCP_PROJECT_ID/team_7/jupyter-server:0.1.0
    ```
...
=== "Linux/macOS"
    ...
    $ polyaxon run -f aisg-context/polyaxon/polyaxonfiles/jupyter-service.yml \
        -P DOCKER_IMAGE="asia.gcr.io/$GCP_PROJECT_ID/team_7/jupyter-server:0.1.0" \
        -P WORKING_DIR="/polyaxon-v1-data" \
        -p aiap-team-7-project-jokebot-<YOUR_NAME>
    ```
