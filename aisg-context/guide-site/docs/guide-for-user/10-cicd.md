...
=== "`.gitlab-ci.yml`"
    ...
    test:pylint-pytest:
      ...
      before_script:
        ...
        - source activate aiap-team-7-project-jokebot
      script:
...
- `asia.gcr.io/aiap-10-ds/team_7/vscode-server`
- `asia.gcr.io/aiap-10-ds/team_7/jupyter-server`
- `asia.gcr.io/aiap-10-ds/team_7/data-prep`
- `asia.gcr.io/aiap-10-ds/team_7/model-train`
- `asia.gcr.io/aiap-10-ds/team_7/fastapi-server`
- `asia.gcr.io/aiap-10-ds/team_7/batch-inference`
- `asia.gcr.io/aiap-10-ds/team_7/streamlit`
    ...
    build:fastapi-server-image:
      ...
      script:
        ...
        - >-
          ...
          --dockerfile "${CI_PROJECT_DIR}/docker/aiap-team-7-project-jokebot-fastapi.Dockerfile"
          --build-arg PRED_MODEL_UUID=${PRED_MODEL_UUID}
          --destination "asia.gcr.io/${GCP_PROJECT_ID}/team_7/fastapi-server:${CI_COMMIT_SHORT_SHA}"
      rules:
        - if: $CI_MERGE_REQUEST_IID
          changes:
            - docker/aiap-team-7-project-jokebot-fastapi.Dockerfile
            - src/**/*
            - conf/**/*
            - scripts/**/*
...
=== "`.gitlab-ci.yml`"
    ...
    build:retag-images:
      ...
      script:
        ...
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/team_7/vscode-server:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/team_7/vscode-server:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/team_7/jupyter-server:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/team_7/jupyter-server:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/team_7/data-prep:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/team_7/data-prep:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/team_7/model-train:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/team_7/model-train:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/team_7/fastapi-server:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/team_7/fastapi-server:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/team_7/batch-inference:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/team_7/batch-inference:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/team_7/streamlit:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/team_7/streamlit:${CI_COMMIT_TAG}"
      rules:
